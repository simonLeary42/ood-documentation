...
doc_context = {
    'ondemand_version':              '1.6',
    # OOD component versions
    'ood_portal_generator_version':  '0.7.1',
    'mod_ood_proxy_version':         '1.4.5',
    'ood_auth_map_version':          '1.4.5',
    'nginx_stage_version':           '1.4.5',
    'dashboard_version':             '1.32.0',
    'shell_version':                 '1.4.2',
    'files_version':                 '1.5.1',
    'file_editor_version':           '1.4.1',
    'active_jobs_version':           '1.8.1',
    'my_jobs_version':               '2.12.0',
    'desktops_version':              '0.2.1',
}
